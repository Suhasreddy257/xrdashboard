            ...
            <p-table [value]="certificatelist" styleClass="mt-4">
                ...
                <ng-template pTemplate="body" let-certificate>
                    <tr>
                        ...
                        <td>
                            <a *ngIf="certificate.certificateURL" [href]="certificate.certificateURL" target="_blank" class="text-blue-600 underline">View Certificate</a>
                            <span *ngIf="!certificate.certificateURL">-</span>
                        </td>
                        <td>
