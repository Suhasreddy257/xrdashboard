                        ...
                        <div *ngFor="let item of items; let i = index" class="col-span-12 sm:col-span-6 lg:col-span-4 p-2">
                            <div class="p-6 border border-surface-200 dark:border-surface-700 bg-surface-0 dark:bg-surface-900 rounded flex flex-col">
                                <div class="relative w-full shadow-sm">
                                    <img class="rounded w-full" src="/images/product/{{ item.image }}" [alt]="item.name" />
                                    <div
                                ...
                                <div class="pt-12">
                                    ...
                                    <div class="flex flex-col gap-6 mt-6">
                                        ...
                                        <div class="flex gap-2">
                                            <p-button icon="pi pi-shopping-cart" label="Buy Now" [disabled]="item.inventoryStatus === 'OUTOFSTOCK'" class="flex-auto whitespace-nowrap" styleClass="w-full" (click)="newEmployee()"></p-button>
                                            <p-button icon="pi pi-heart" styleClass="h-full" [outlined]="true"></p-button>
                                        </div>
                                    </div>
                                </div>
...
export class ListDemo implements OnInit{
    ...
    newEmployee() {
        this.router.navigate(['/uikit/view']);
    }
}
