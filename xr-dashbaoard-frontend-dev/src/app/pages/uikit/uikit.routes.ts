...
export default [
    ...
    { path: 'view', data: { breadcrumb: 'View' }, loadComponent: () => import('./trainingmodelview').then((c) => c.View) },
    { path: 'listdemo', data: { breadcrumb: 'Training Module' }, loadComponent: () => import('./listdemo').then((c) => c.ListDemo) },
