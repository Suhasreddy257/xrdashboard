            ...
            <ng-template #caption>
                <div class="flex justify-between items-center flex-col sm:flex-row w-full">
                    <div class="mb-3 flex gap-2">
                        <button pButton type="button" label="Export Selected" class="p-button-primary"></button>
                        <button pButton type="button" label="Export All" class="p-button-primary"></button>
                    </div>
                    <div class="flex gap-2 ml-auto">
                        ...
                        <button pButton type="button" label="Import" class="p-button-primary"></button>
            ...
            <ng-template #body let-employee>
                <tr>
                    <td class="text-center align-middle" style="vertical-align: middle; text-align: center;">
                        <div style="display: flex; justify-content: center; align-items: center; height: 100%;">
                            <p-tableCheckbox
                                ...
                                [value]="employee"
                                (onChange)="onRowSelect($event, employee)"
                            ></p-tableCheckbox>
                        </div>
                    </td>                       
                    ...
                    <td class="text-center" style="vertical-align: middle;">
                        <button pButton type="button" icon="pi pi-pencil" class="p-button-rounded p-button-text p-button-sm mr-1" pTooltip="Edit" (click)="editEmployee(employee.userID)"></button>
                        <button pButton type="button" icon="pi pi-trash" class="p-button-rounded p-button-text p-button-danger p-button-sm" pTooltip="Delete" (click)="deleteEmployee(employee)"></button>
                    </td>
                </tr>
            </ng-template>
...
export class AdminTable implements OnInit {
    ...
    onRowSelect(event: any, employee: Employee) {
