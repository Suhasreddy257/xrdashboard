...
export class UsersTable implements OnInit {
    ...
    export() {
        this.router.navigate(['/user/user-export']);
    }    

    deleteEmployee(employee: Users) {
        //this.messageService.add({ severity: 'warn', summary: 'Delete', detail: `Delete employee: ${employee.first_name} ${employee.last_name}` });
    }
