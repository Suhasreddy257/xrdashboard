...
export class UserService {
    ...
    getAllUser(): Observable<any> {
        ...
        return this.http.post<any>(this.users, payload);
    }
    ...
    putUserEdit(employeeData: any) {       
        ...
        return this.http.post<any>(this.url4, payload);
    }
    ...
    deleteUser(userID: number): Observable<any> {
        ...
        const deleteUrl = `${environment.apiUrl}/User/put_UserDelete`;
        return this.http.post<any>(deleteUrl, payload);
    }
}
